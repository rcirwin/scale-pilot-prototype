...
// ---------------------------------------------------------------------------
// Production SI nav items — linked to real app destinations
// ---------------------------------------------------------------------------
...
const productionItems: ProductionNavItem[] = [
  {
    ...
    href: 'https://portal.scaleinsights.com/',
  },
  {
    label: 'Sales',
    ...
    href: 'https://portal.scaleinsights.com/Sales/Region',
  },
  {
    label: 'Products',
  ...
  },
  {
    ...
    href: 'https://portal.scaleinsights.com/Restock',
  },
  {
    ...
    href: 'https://portal.scaleinsights.com/KeywordRanking',
  },
  {
    label: 'Ads Insights',
    ...
    href: 'https://portal.scaleinsights.com/Ads/Insights',
  },
  {
    label: 'Automation',
    ...
    href: 'https://portal.scaleinsights.com/Automation',
  },
  {
    ...
    href: 'https://portal.scaleinsights.com/MassCampaigns',
  },
  {
    ...
    href: 'https://portal.scaleinsights.com/StrategyExperts',
  },
];
...
export function Sidebar() {
  ...
  const isPilotActive = (href: string) => {
    ...
    if (href === '/findings') return pathname.startsWith('/findings');
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 flex flex-col w-full overflow-y-auto overflow-x-hidden">
          {/* Production SI items — link to live app */}
          {productionItems.map((item) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center w-full cursor-pointer transition-colors hover:bg-white/5 shrink-0"
